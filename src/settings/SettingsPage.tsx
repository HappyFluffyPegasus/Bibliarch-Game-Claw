...
import { 
  ...
  Keyboard, HelpCircle, ChevronRight, Save
} from 'lucide-react';
...
const settingsSections: SettingsSection[] = [
  { id: 'account', name: 'Account', icon: User, description: 'Manage your profile and preferences' },
  { id: 'appearance', name: 'Appearance', icon: Palette, description: 'Themes, colors, and display' },
  { id: 'notifications', name: 'Notifications', icon: Bell, description: 'Email and push notification settings' },
  { id: 'privacy', name: 'Privacy', icon: Shield, description: 'Data sharing and visibility' },
  { id: 'data', name: 'Data Management', icon: Database, description: 'Export, backup, and delete data' },
  { id: 'shortcuts', name: 'Keyboard Shortcuts', icon: Keyboard, description: 'Customize hotkeys' },
];
...
export function SettingsPage() {
  ...
  const exportData = () => {
    const data = {
      stories: [], // Would come from database
      characters: [],
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <button className="mt-2 text-sm text-primary">Change avatar</button>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea 
                      defaultValue="Creating worlds, one story at a time."
                ...
                <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      compactMode ? "bg-primary" : "bg-muted-foreground/30"
                    )}
                  >
                    <div className={cn(
                  ...
                  <div className="flex items-center justify-between p-4 border border-border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Download all your stories and settings</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-destructive/30 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Permanently remove all stories and settings</p>
                      </div>
                    </div>
              ...
              <GlassCard className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between text-sm mb-1">
                      <span>Other</span>
                      <span className="text-muted-foreground">12 MB</span>
                    </div>
                    <div className="h-2 bg-muted rounded-full overflow-hidden">
                ...
                {[
                  ...
                  <div key={action} className="flex items-center justify-between py-2">
                    ...
                    <div className="flex items-center gap-1">
                      <{keys.map((key, i) => (
                        <>
                          <kbd key={key} className="px-2 py-1 bg-muted rounded text-sm font-mono">{key}</kbd>
